...
public class UserRepository {
    ...
    public Mono<Void> createUser(UserPO userPO) {
        return connectionMono.flatMap(connection -> Mono.from(connection.createStatement(createUserSQL)
    ...
    public Mono<String> login(String username) {
        return connectionMono
                .flatMap(connection -> Mono.from(connection.createStatement(loginSQl)
